...
const Reply = forwardRef<HTMLDivElement, Props>(
	({ reply, cheetId, setReplies, isModalMounted, isCheetLoading }, ref) => {
										...
										>
											{isEditing ? (
												...
												<IconButton
													...
													sx={{
														pointerEvents: isLoading || isCheetLoading ? "none" : undefined,
													}}
												>
													<Edit />
												</IconButton>
								...
								<Grid2 size={1}>
									{userId === reply.user.uuid && (
										...
										>
											<IconButton
												onClick={deleteReply}
												sx={{ pointerEvents: isLoading || isCheetLoading ? "none" : undefined }}
											>
												<Delete />
											</IconButton>
										</LoadingSpinner>
